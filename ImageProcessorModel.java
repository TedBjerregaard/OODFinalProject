...
public interface ImageProcessorModel {
  ...
  /**
   * Applies a filter (Kernel) to an image and creates a blurred version of the
   * same image.
   *
  ...
  /**
   * Applies a filter (Kernel) to an image and creates a sharpened version of the
   * same image.
   *
  ...
  /**
   * Exports an image with a specified file name and type.
   * Currently, only able to export ".ppm" files.
   *
